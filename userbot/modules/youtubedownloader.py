...
from userbot.utils.tools import is_ffmpeg_there, ProgressCallback
from userbot.utils.yt_dl import (extract_info, list_formats,
...
@register(outgoing=True, pattern="^.ytdl(?: |$)(.*)")
