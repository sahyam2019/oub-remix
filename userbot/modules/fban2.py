...
@register(outgoing=True, disable_edited=True, pattern=r"^\.fban2(?: |$)(.*)")
...
@register(outgoing=True, disable_edited=True, pattern=r"^\.unfban2(?: |$)(.*)")
...
@register(outgoing=True, pattern=r"^\.addf2 *(.*)")
...
@register(outgoing=True, pattern=r"^\.listf2$")
...
CMD_HELP.update({"fban": "`.fban2` <id/username> <reason>"
