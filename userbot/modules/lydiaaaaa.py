...
@register(outgoing=True, pattern="^.repli$")
...
@register(outgoing=True, pattern="^.addli$")
...
@register(outgoing=True, pattern="^.remli$")
...
CMD_HELP.update({
    "lydia":
    ".addli <username/reply>\
\nUsage: add's lydia auto chat request in the chat.\
\n\n.remli <username/reply>\
\nUsage: remove's lydia auto chat request in the chat.\
\n\n.repli <username/reply>\
\nUsage: starts lydia repling to perticular person in the chat.\
\n Note: set LYDIA_API_KEY in vars to make this work. G et your value from https://coffeehouse.intellivoid.net."
})
