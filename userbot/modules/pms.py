        ...
        if event.is_private and event.chat_id != 777000 and event.chat_id != self_user.id and not (
            ...
            if not apprv and event.text != UNAPPROVED_MSG:
                ...
                if COUNT_PM[event.chat_id] > 3:
                    await event.respond(
                        "`You are found to be guilty for spamming my master's PM`\n"
                        "`\nUserbot has BLOCKED and reported you as SPAM.\nNo further message will be passed to Akash from your side`\n\n∆ autogenerated message ∆"
                    )
...
async def blockpm(block):
    ...
    if block.reply_to_msg_id:
        ...
        await block.edit("`You've been blocked by Akash!`")
        name0 = str(aname.first_name)
        uid = block.chat_id
...
async def unblockpm(unblock):
    ...
    if unblock.reply_to_msg_id:
        ...
        await unblock.edit("`You have been unblocked by Akash.`")
