...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
    "`hey there, this is an automated message. if you wanna talk to me, ask permission in group else you'll be reported as spam.`" \n\n`")
# =================================================================
        ...
        if event.is_private and event.chat_id != 777000 and event.chat_id != self_user.id and not (
            ...
            if not apprv and event.text != UNAPPROVED_MSG:
                ...
                if COUNT_PM[event.chat_id] > 2:
                    await event.respond(
                        "𝗬𝗼𝘂 𝘄𝗲𝗿𝗲 𝘀𝗽𝗮𝗺𝗺𝗶𝗻𝗴 𝗺𝘆 𝗽𝗺 𝗱𝘂𝗱𝗲"\n"
                        "𝘆𝗼𝘂'𝗿𝗲 𝗯𝗹𝗼𝗰𝗸𝗲𝗱 𝗮𝗻𝗱 𝗿𝗲𝗽𝗼𝗿𝘁𝗲𝗱."
                    )
