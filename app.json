{
  ...
  "logo": "https://telegra.ph/file/90b4e03927ad8d90825ea.jpg",
  "keywords": [
    "telegram",
    "userbot",
    "plugin",
  ...
  "repository": "https://github.com/sahyam2019/oub-remix",
  ...
  "env": {
    ...
    "PM_LOGGR_BOT_API_ID": {
      "description": "send .getid in any channel to forward all your NEW PMs to this group",
      "required": false
    },
    "GENIUS": {
    ...
    "DEFAULT_BIO": {
      ...
      "value": "[PM = Report Spam] I ❤ ️@oub-remix",
      "required": false
    },
    "ALIVE_NAME": {
    ...
    "G_BAN_LOGGER_GROUP": {
      "description": "Add all sudo bots in your group and type id of that group.",
      "required": false
    },
    "G_DRIVE_DATA": {
